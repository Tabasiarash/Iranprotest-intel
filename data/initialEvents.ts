...
export const INITIAL_EVENTS: IntelEvent[] = [
  ...
  },
  {
    ...
    "summary": "The Islamic Republic has implemented a massive shutdown of internet and mobile communication networks across Iran to disrupt calls for protests by Prince Reza Pahlavi and to prevent the reporting of million-strong crowds in the streets.",
    "category": EventCategory.CIVIL_UNREST,
    "date": "2026-01-09",
    "locationName": "Iran",
    "lat": 32.4279,
  ...
  },
  {
    ...
    "title": "Large Protest in Pounak",
    "summary": "A large crowd of protesters gathered in the Poonak neighborhood of Tehran on Friday evening, despite heavy security and communication disruptions.",
    "category": EventCategory.CIVIL_UNREST,
    "date": "2026-01-09",
